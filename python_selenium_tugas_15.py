...
class TestLogin(unittest.TestCase): 
    ...
    def test_a_success_register(self): 
        ...
        time.sleep(1)
        browser.find_element(By.XPATH,"/html[1]/body[1]/div[1]/div[1]/form[1]/input[1]").send_keys("atikapprinda") # isi username
        time.sleep(1)
        browser.find_element(By.XPATH,"/html[1]/body[1]/div[1]/div[1]/form[1]/input[2]").send_keys("atikapprinda@gmail.com") # isi email
        time.sleep(1)
        browser.find_element(By.CSS_SELECTOR,"#password_register").send_keys("password") # isi password
        time.sleep(1)
    ...
    def test_a_failed_register_with_empty_username(self): 
        ...
        self.assertEqual(response_message, 'username is mandatory')
